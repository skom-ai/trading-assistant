...
DB="${POSTGRES_DB:-quantmind}"
USER="${POSTGRES_USER:-quantmind}"
BASE_DIR="/quantmind-sql"

log() { echo "[quantmind-db-init] $*"; }
...
log "Starting QuantMind schema + seed initialization for db=${DB}"
