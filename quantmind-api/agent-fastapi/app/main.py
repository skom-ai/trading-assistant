...
Date: 2026-09-07
Description:
    Wires the QuantMind agent service: structured logging, correlation-id
...
def create_app() -> FastAPI:
    ...
    logger.info("QuantMind agent service ready (llm_provider=%s)", settings.llm_provider)
    return app
