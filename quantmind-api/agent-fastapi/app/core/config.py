...
Date: 2026-09-07
Description:
    Centralized, typed settings for the QuantMind agent service, loaded
...
class Settings(BaseSettings):
    ...
    service_name: str = "quantmind-agent"
    environment: str = "local"
    log_level: str = "INFO"

    postgres_dsn: str = "postgresql+psycopg://quantmind:quantmind@postgres:5432/quantmind"
    redis_url: str = "redis://redis:6379/0"
    mongo_url: str = "mongodb://root:root@mongo:27017"
    mongo_db: str = "quantmind_traces"
    ...
    def resolved_api_key(self) -> str | None:
        ...
        Precedence: QM_LLM_API_KEY (typed setting) first, then the plain
