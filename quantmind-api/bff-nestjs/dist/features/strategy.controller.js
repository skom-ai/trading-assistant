...
let StrategyController = class StrategyController {
    ...
    async generate(body, req) {
        return this.agent.post('/internal/v1/strategy', {
            symbol: body.symbol,
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'FR3 strategy + FR4 analog co-execution' }),
    __param(0, (0, common_1.Body)()),
    __param(1, (0, common_1.Req)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [dtos_1.StrategyDto, Object]),
    __metadata("design:returntype", Promise)
], StrategyController.prototype, "generate", null);
exports.StrategyController = StrategyController = __decorate([
    (0, swagger_1.ApiTags)('FR3 Strategy + FR4 Analogs'),
    (0, common_1.Controller)('api/v1/strategy'),
