...
npx newman run tests/postman/quantmind-bff.postman_collection.json \
...
```bash
# Stack must be running; target overridable via QM_PENTEST_TARGET
cd agent-fastapi
QM_PENTEST_TARGET=http://localhost:8080 \
