# Valtide DB — Data Layer

**Component:** `valtide-db` | **Part of:** AI Stock Opportunity Discovery & Strategy Platform
...
docker compose exec postgres psql -U valtide -d valtide -c '\dt'

# Verify Mongo collections
docker compose exec mongo mongosh valtide_traces --eval 'db.getCollectionNames()'
```
